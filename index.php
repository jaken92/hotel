...
<body>
    ...
    <div id="basic" class="sections">
        ...
        <p>Enjoy this gem of an island fully by sleeping under the blue sky on the beach. Your stay includes a very cosy blanket the we wash occasionaly, aswell as an almost waterproof parasol. If you select this option we warmly reccomend you to preorder the feature "baseball-bat" as you might need to fend off the raccoons that terrorize our guests during nighttime.
        </p>
    </div>
